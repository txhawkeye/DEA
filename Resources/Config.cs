...
{
    public static readonly string TOKEN = "Mjg5OTgwNjA1ODg4NzI1MDAz.C6c6RQ.9IroIkqdrCrvX7n1PHZO3mXt5qE";
    ...
    HIGHEST_STEAL = 500, MAX_RESOURCES = 1000, MIN_RESOURCES, TEMP_MULTIPLIER_RATE = 0.5f, MIN_BET = 0.05f, MIN_PERCENTAGE = 0.05f;
