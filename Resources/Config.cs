...
public static class Config
{
    ...
    STEAL_ODDS = 80, MIN_CHILL = 5, MAX_CHILL = (int)TimeSpan.FromHours(1).TotalSeconds, MIN_CLEAR = 2, MAX_CLEAR = 1000;
    ...
    MIN_RESOURCES = 25, TEMP_MULTIPLIER_RATE = 0.2f, DEA_TEMP_MULTIPLIER_RATE = 0.4f, SPONSOR_TEMP_MULTIPLIER_RATE = 0.6f, MIN_PERCENTAGE = 0.05f, 
        
    DONATE_MIN = 5, BET_MIN = 5;

    public static readonly ulong SPONSORED_ROLE_ID = 292687552710705162, DEA_SERVER_ID = 290759415362224139;
    ...
    244622383544008706, 254678168122818570 };
